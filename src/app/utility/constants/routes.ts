export class RouteConstants {
  ...
  public static ETHER_BALANCE = 'ether-balance';
  public static TOKEN_BALANCE = 'token-balance';
  ...
  public static REFERRAR_PROGRAM = 'referrals';
  public static REFERRAR_STATUS = 'referral_status';
